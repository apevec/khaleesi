...
baseurl=http://{{ rh_download_server }}/released/RHEL-7/7.0/Workstation/x86_64/os/ 
enabled=1
gpgcheck=0

[rhel7internal-optional]
name=internal rhel repo
baseurl=http://{{ rh_download_server }}/released/RHEL-7/7.0/Workstation-optional/x86_64/os/ 
enabled=1
gpgcheck=0
EOF
